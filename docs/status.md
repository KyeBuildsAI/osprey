...
Evidence basis: protected authoritative `main` following reconciliation
baseline `b59d0c1`; its application tree derives from deployed commit
`a6338f2`. The separate uncommitted, user-owned
