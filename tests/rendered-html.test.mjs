...
test("server-renders the Houston–Galveston incident room", async () => {
  ...
  assert.match(html, /Human decisions, actions and audit/);
  ...
  assert.match(html, /HUMAN APPROVAL CENTRE/);
  assert.match(html, /Decisions &amp; Actions/);
  assert.match(html, /Needs your decision/);
  assert.match(html, /In progress/);
  assert.match(html, /Decision history/);
  assert.match(html, /WHAT APPROVAL WILL DO/);
